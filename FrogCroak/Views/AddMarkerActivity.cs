...
namespace FrogCroak.Views
{
    ...
    public class AddMarkerActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            helper = new MyDBHelper(this, "frog.db", null, 1);
            initView();
        ...
        public void AddMarker()
        {
            if (!tv_Latitude.Text.Equals(""))
            {
                ...
                if (Title != "" && Content != "")
                {
                    ...
                    values.Put("latitude", tv_Latitude.Text);
                    values.Put("longitude", tv_Longitude.Text);
                    values.Put("title", et_Title.Text);
                    values.Put("content", et_Content.Text);
                    long id = helper.WritableDatabase.Insert("marker", null, values);
